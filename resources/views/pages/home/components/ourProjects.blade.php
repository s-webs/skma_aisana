<div class="relative bg-custom-mainDark">
    ...
    <div class="container mx-auto relative z-[20] py-[50px] px-[30px]">
        <div class="text-center text-custom-primary text-2xl lg:text-[48px] font-bold">
            <h3>{{ __('public.our_projects') }}</h3>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-[30px] auto-rows-fr mt-[50px]">
            @foreach($projects as $project)
                <div class="bg-custom-main pt-[25px] rounded-[12px] overflow-hidden p-[20px] flex flex-col h-full">
                    <div
                        class="flex items-center justify-center w-[90px] h-[90px] rounded-full bg-custom-primary overflow-hidden mx-auto">
                    ...
                    <div class="mt-auto pt-[20px]">
                        <div
                            ...
                            <div
                                class="absolute left-0 top-0 h-full rounded-full bg-gradient-to-r from-white/80 to-white/60"
